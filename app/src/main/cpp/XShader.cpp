...
static GLuint InitShader(const char *code,GLint type)
{
    ...
    XLOGE("XShader:: glCompileShader() success!");
    return sh;
}
...
bool XShader::Init()
{
    ...
    if(vsh == 0)
    {
        XLOGE("XShader:: InitShader GL_VERTEX_SHADER failed!");
        return false;
    }
    XLOGI("XShader:: InitShader GL_VERTEX_SHADER success!");
    ...
    if(status != GL_TRUE)
    {
        XLOGE("XShader:: glLinkProgram failed!");
        return false;
    }
    glUseProgram(program);
    XLOGI("XShader: glLinkProgram success!");
    /////////////////////////////////////////////////////////////
